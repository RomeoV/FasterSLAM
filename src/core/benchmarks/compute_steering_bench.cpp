...
//    data_loader(x, wp, N_wp, minD, rateG, maxG, dt, &iwp, &G);
//    bench.funcFlops[1] = compute_steering_base_flops(x, wp, N_wp, minD, rateG, maxG, dt, &iwp, &G);
//    bench.funcBytes[1] = compute_steering_base_memory(x, wp, N_wp, minD, rateG, maxG, dt, &iwp, &G);
//
