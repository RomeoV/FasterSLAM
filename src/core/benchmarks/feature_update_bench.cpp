...
int main() {
    ...
    data_loader(&p, z, idf, N_idf, R, zp, Hv, Hf, Sf);
    ...
    bench.funcFlops[0] = feature_update_base_flops(&p, z, idf, N_idf, R, zp, Hv, Hf, Sf);
    bench.funcBytes[0] = feature_update_base_memory(&p, z, idf, N_idf, R, zp, Hv, Hf, Sf);
    bench.add_function(&feature_update, "feature_update", 0.0);
    bench.funcFlops[1] = feature_update_active_flops(&p, z, idf, N_idf, R, zp, Hv, Hf, Sf);
    bench.funcBytes[1] = feature_update_active_memory(&p, z, idf, N_idf, R, zp, Hv, Hf, Sf);
