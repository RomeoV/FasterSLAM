...
auto compute_jacobians_fast_4particles_wrapper = [](
    ...
    compute_jacobians_fast_4particles(particle4, idf, N_z, R, zp4, Hv4, Hf4, Sf4);
...
int main() {
    ...
    compute_jacobians_functions = {
      ...
      {"compute_jacobians_fast_4particles", compute_jacobians_fast_4particles_wrapper},
